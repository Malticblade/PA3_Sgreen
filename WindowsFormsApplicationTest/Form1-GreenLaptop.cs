...
namespace WindowsFormsApplicationTest
{
    public partial class frmMain : Form
    {
        ...
        public static String getWeightClass(double pokeWeight)
        {
            ...
            else if (pokeWeight < 100 && pokeWeight >= 1)
            {
        ...
        public static String getHeightClass(double pokeHeight)
        {
            ...
            else if (pokeHeight < 30 && pokeHeight >= 1)
            {
        ...
        public void btnConvert_Click(object sender, EventArgs e)
        {
            ...
            if (txtbxName.Text == ""|| pokeName.Length < 3) 
            {
                MessageBox.Show("INVALID NAME /nPlease Enter a Name With 3 or more characters.");
                clearControls();
                txtbxName.Focus();
            }
            else
            {
                ...
                try
                {
                    ...
                    if (pokeHeight < 0.001 || pokeHeight > 1000)
                    {
                    ...
                    else if (pokeWeight < 0.01 || pokeWeight > 9000)
                    {
